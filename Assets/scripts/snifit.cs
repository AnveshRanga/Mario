...
public class snifit : body
{
    ...
    public override void Attack()
    {
        ...
        Rigidbody Ball = Instantiate(ball, m_FireTransform.position, m_FireTransform.rotation) as Rigidbody;
    ...
    {
        Debug.Log("turn" + turn);
        Quaternion deltaRotation = Quaternion.Euler(rotateAngle * turn * 90.0f);
